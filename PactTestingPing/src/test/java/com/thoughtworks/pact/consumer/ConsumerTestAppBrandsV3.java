...
public class ConsumerTestAppBrandsV3 {
    ...
    @Rule
    public PactProviderRule provider = new PactProviderRule("brands_provider_v3", "localhost", 8000, this);
    ...
    @Test
    @PactVerification("brands_provider_v3")
    public void runTest() {
